window.STATE =
{
  ...
  "updatedAt": "2026-09-21T21:29:58+03:00",
  "finishedAt": null,
  "stages": [
    ...
    {"id":"final","status":"active","startedAt":"2026-09-21T05:29:05+03:00","note":"T17–T20 blind PASS; draft v2 ожидает ручной проверки и подтверждения владельцем"}
  ],
  "requirements":{"total":93,"done":93,"inTicket":0,"inSpec":0,"placeholder":0,"deferred":0,"dropped":0},
  "tickets":[
  {
    "id": "01",
  ...
  "blind":{"status":"partial","checkedAt":"2026-09-21T21:29:58+03:00","productionUpdatedAt":"2026-09-21T21:29:58+03:00","agreed":["local single-owner app","profile/CV","50-source registry","matching","research/drafts","monitoring contracts","backup bundle","design audit","VPS deploy","HTTPS","controlled restart","production owner","production 9+41 source registry","OpenAI live authentication","Tavily live search","Brave application Context-to-Web fallback","Telegram Bot API identity and owner chat","encrypted production backups","backup timer","unaffected Eggent/SkyPay/blog","Sources table layout and production rollout","Readable CV preview and exact raw view","gpt-5-mini model and exact price","daily budget 5 USD","bounded OpenAI worker/transport timeout 120 seconds","profile output limit 8000","durable unconfirmed draft v2 loadable through profile UI path","T17–T20 blind acceptance PASS"],"drift":["Telegram MTProto reader awaits API_ID/API_HASH","off-server decrypt/verify and restore drill pending","monitoring remains disabled until draft v2 is manually reviewed and profile confirmed_version is greater than zero"],"commands":"Latest full Django 374 passed (1 skipped); UI 10; final blind targeted 6 passed; production image 20260921T154656Z healthy; budget 5.0000; model gpt-5-mini with exact prices; output limit 8000; draft v2 loadable with 42 unconfirmed items and confirmed_version=0; usage settled=1 cost 0.0105, pending=4, reserved=0; HTTPS health/login 200; Eggent 307, SkyPay/blog 200; backup job-system-20260921T154633Z.tar.age"},
